...
You can install _apbr_ using the following command:

You can download binary [releases](https://github.com/apibrew/apibrew/releases/latest).

<Tabs>
    <TabItem value="macos_silicon" label="Macos[Apple Silicon]" default>
        ```bash
        wget https://github.com/apibrew/apibrew/releases/download/v1.3.34/apbr-darwin-arm64
        chmod +x apbr-darwin-arm64
        sudo mv apbr-darwin-arm64 /usr/local/bin/apbr
        ```
    </TabItem>
    <TabItem value="macos_intel" label="Macos[Intel]" default>
        ```bash
        wget https://github.com/apibrew/apibrew/releases/download/v1.3.34/apbr-darwin-amd64
        chmod +x apbr-darwin-amd64
        sudo mv apbr-darwin-amd64 /usr/local/bin/apbr
        ```
    </TabItem>
    <TabItem value="linux_amd_64" label="Linux[x86_64]" default>
        ```bash
        wget https://github.com/apibrew/apibrew/releases/download/v1.3.34/apbr-linux-amd64
        chmod +x apbr-linux-amd64
        sudo mv apbr-linux-amd64 /usr/local/bin/apbr
        ```
    </TabItem>
</Tabs>
